...
<head>
	...
	<link rel="stylesheet" href="/cas/css/cas.min.css;jsessionid=0173C372243B6C61398FC40BC2176471.jvm1" />
	...
	<![endif]-->
		...
		<script>
			if(typeof(Storage) !== "undefined") {
				localStorage.setItem("pt.ulisboa.tecnico.dsi.ImageNumber", 1);	
			}
		</script>
	
	
	
		<div id="bg" style="background-image: url(//static.tecnico.ulisboa.pt/projects/tecnico-id/bg-01-blur.jpg); background-size:cover; background-repeat:no-repeat;"></div>
...
<form id="credential" action="/cas/login;jsessionid=0173C372243B6C61398FC40BC2176471.jvm1?service=https:%2F%2Ffenix.tecnico.ulisboa.pt%2Fapi%2Fcas-client%2Flogin%2FaHR0cHM6Ly9mZW5peC50ZWNuaWNvLnVsaXNib2EucHQvZG93bmxvYWRGaWxlLzExMjY1MTgzODIzMDE2NzMvbGFkcmlsaG9fdmFsaWRvLmNwcA==" method="post">
	<!-- Técnico ID -->
	...
	<!-- end fieldset Técnico ID -->
		...
		<fieldset data-selection="kerberos">
			...
			<input id="submit-kerberos" name="submit-kerberos" type="button" class="button button-active button-wide"
				...
				onClick="location.href='/cas/login?service=https:%2F%2Ffenix.tecnico.ulisboa.pt%2Fapi%2Fcas-client%2Flogin%2FaHR0cHM6Ly9mZW5peC50ZWNuaWNvLnVsaXNib2EucHQvZG93bmxvYWRGaWxlLzExMjY1MTgzODIzMDE2NzMvbGFkcmlsaG9fdmFsaWRvLmNwcA==&auth=spnego'">
		</fieldset>
		<!-- end KERBEROS -->
		...
		<fieldset data-selection="cartaocidadao">
			...
			<input id="submit-ccidadao" name="submit-ccidadao" type="button" class="button button-active button-wide"
				...
				onClick="location.href='https://x509.id.tecnico.ulisboa.pt/cas/login?service=https:%2F%2Ffenix.tecnico.ulisboa.pt%2Fapi%2Fcas-client%2Flogin%2FaHR0cHM6Ly9mZW5peC50ZWNuaWNvLnVsaXNib2EucHQvZG93bmxvYWRGaWxlLzExMjY1MTgzODIzMDE2NzMvbGFkcmlsaG9fdmFsaWRvLmNwcA==&auth=x509&language=pt'">
		</fieldset>
		<!-- end CARTÃO CIDADÃO -->
	...
	<input type="hidden" name="lt" value="LT-62831-BKoN6UaijAGouGbIObTsIyp3lPffRW-id.tecnico.ulisboa.pt" />
...
<script src="/cas/js/cas.min.js;jsessionid=0173C372243B6C61398FC40BC2176471.jvm1"></script>
